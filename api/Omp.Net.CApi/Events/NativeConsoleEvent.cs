...
internal static partial class NativeConsoleEvent
{
	...
	private static unsafe bool OnConsoleText(IntPtr command, IntPtr parameters, void* senderDataPtr)
	{
		...
		unsafe
		{
			...
			return NativeOnConsoleText(Marshal.PtrToStringAnsi(command) ?? string.Empty, Marshal.PtrToStringAnsi(parameters) ?? string.Empty, senderType);
		}
	}
